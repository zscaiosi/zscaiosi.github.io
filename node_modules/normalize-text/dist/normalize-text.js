...
var object_getownpropertydescriptors = implementation$9;
...
var toProperty = function (ref) {
  ...
  var property = object_assign({}, descriptor, { name: name });
  return property;
};

var getProperties = function (object) {
  var descriptors = object_getownpropertydescriptors(object);
  var properties = map(object_entries(descriptors), toProperty);
  return properties;
};
...
var withMethod = function (object, ref) {
  ...
  var result = object_assign({}, object, ( obj = {}, obj[name] = Function.call.bind(value), obj));
  return result;
};
...
var reduce$2 = ref.reduceRight;

var compose = (function () {
	var λs = [], len = arguments.length;
	while ( len-- ) λs[ len ] = arguments[ len ];

	return function (value) { return reduce$2(λs, function (value, λ) { return λ(value); }, value); };
});
 ...
 * @returns {string}
 */
var normalizeWhitespaces = compose(function (value) { return replace$1(value, /\s{2,}|\r?\n|\t/g, WHITESPACE); }, function (value) { return trim$1(value); });
 ...
 * @returns {string}
 */
var normalizeDiacritics = compose(function (value) { return replace$1(value, /[\u0080-\uF8FF]/g, ''); }, function (value) { return normalize(value, 'NFKD'); });
 ...
 * @returns {string}
 */
var normalizeParagraph = compose(function (value) { return replace$1(value, value[0], upper(value[0])); }, function (value) { return value[value.length - 1] === '.' ? value : value + '.'; }, normalizeWhitespaces);
